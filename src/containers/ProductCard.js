...
componentDidMount(){
        axios.get('https://sublimat-back.herokuapp.com/product')
        .then(res => {
...
deletePost = (postId) => {
    axios.delete(`https://sublimat-back.herokuapp.com/product${postId}`)
    .then(response => {
        ...
        <ul>
            {this.state.persons.map(person => (
                ...
                <Card.Body>
                    ...
                    <Button variant='secondary' onClick={this.deletePost.bind(this, person._id)}>ver</Button>
                </Card.Body>
                </Card>
                /*<div className="card" >
